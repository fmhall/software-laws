...
- It opposes the pessimism of [Amdahl's Law](amdahls-law.md) by assuming the size of the problem to be solved will increase proportionally with computing power, so that parallel processors remain busy.
