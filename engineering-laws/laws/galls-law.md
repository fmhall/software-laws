...
level: Senior
summary: A complex system that works is invariably found to have evolved from a simple system that worked. Start with a simple, functional architecture and add complexity incrementally rather than designing a complex system from scratch.
...
**John Gall**, an American pediatrician with a sideline in systems theory, published _Systemantics: How Systems Work and Especially How They Fail_ in 1975. 30 publishers initially rejected the book before it became a cult classic.

The third edition (2002) of the book is named _The Systems Bible_.
