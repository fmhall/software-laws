...
By thinking about failure modes, you add features like circuit breakers, retries, or failover strategies. Inversion pairs well with [First-Principles Thinking](first-principles-thinking.md) and represents a form of defensive design leading to robust outcomes by avoiding possible problems.
