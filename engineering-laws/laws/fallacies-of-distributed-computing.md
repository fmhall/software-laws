...
category: Laws of Software Engineering
level: Senior
summary: Eight false assumptions that developers new to distributed systems commonly make, treating networked systems like local ones and ignoring real-world network behavior.
