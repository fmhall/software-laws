...
level: Senior
summary: Small, successful systems tend to be followed by overengineered, bloated replacements. The second version often incorporates excessive features and complexity that the original lacked.
...
Fred Brooks coined the term in 1975 in _The Mythical Man-Month_. He observed it in practice at IBM, where successful small systems (such as simplistic tape-based OS) were followed by OSes that tried to do far more and ran late or failed.
