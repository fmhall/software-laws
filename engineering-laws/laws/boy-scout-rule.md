...
category: Quality
level: Junior
summary: Leave the code better than you found it through constant, incremental improvements rather than large rewrites. Small polishing efforts compound over time to transform a codebase.
...
As a result, adopting the Boy Scout Rule helps teams avoid the [Broken Windows](broken-windows-theory.md) effect in software development.
