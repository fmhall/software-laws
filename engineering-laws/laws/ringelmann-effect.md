...
category: Teams
level: Mid-Level
summary: Individual productivity decreases as group size increases due to coordination overhead and reduced accountability in larger teams.
source: https://lawsofsoftwareengineering.com/laws/ringelmann-effect
---
...
This effect warns that adding team members can make each existing member less efficient. Along with [Brooks's Law](brooks-law.md), it shows that teamwork doesn't scale linearly. Teams must be structured to mitigate this with clear roles and small, focused groups.
