...
category: Planning
level: Junior
summary: Work expands to fill the time available for its completion. Loose deadlines reduce productivity, so teams should set clear, realistic time limits balanced against the risk of over-compression.
...
Agile methodologies use time-boxing as a direct counter to Parkinson's Law. Sprints, daily standups, and fixed iteration cycles all create artificial constraints that focus effort.

However, it is essential to remain aware of Hofstadter's Law: we should not set impossibly short deadlines, as you will consistently be late or burn out your team.
