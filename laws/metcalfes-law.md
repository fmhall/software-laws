...
category: Scale
level: Senior
summary: The value of a network is proportional to the square of the number of users. Each new user creates exponential value through increased connection opportunities, driving winner-takes-all dynamics in technology platforms.
source: https://lawsofsoftwareengineering.com/laws/metcalfes-law
---
